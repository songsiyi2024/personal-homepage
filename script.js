...
const translations = {
  zh: {
    ...
    "resume-focus-value": "前端开发、数据分析、AI 应用",
    "resume-edu-h2": "教育与学习",
    "resume-edu-copy": "持续进行数学、计算机与英语相关课程学习，关注工程能力和长期输出能力建设。",
    ...
    "cwk-docs-h3": "文档区",
    "cwk-docs-copy": "这个栏目只放课程作业文档。你可以把文件放进 docs/coursework 目录，然后在这里补一条卡片链接。",
  ...
  en: {
    ...
    "resume-focus-value": "Frontend development, data analysis, and AI application",
    "resume-edu-h2": "Education & Learning",
    "resume-edu-copy": "Continuously learning mathematics, computer science, and English with a focus on engineering depth and long-term output.",
    ...
    "cwk-docs-copy": "This page only hosts coursework documents. Put files in docs/coursework and add links here.",
...
function renderRunningStats() {
  ...
  const statItems = document.querySelectorAll(".running-stat[data-stat]");
