...
const translations = {
  zh: {
    ...
    "resume-education-coursework-link": "查看课程作业档案",
    ...
    "resume-project-repo-link": "查看 GitHub 协作仓库",
    "resume-view-projects": "查看项目页",
    "resume-view-articles": "查看文章页",
    "resume-awards-h2": "荣誉与奖励",
    "resume-award-1-name": "北京大学李惠荣奖学金",
    "resume-award-1-detail": "2024–2025 学年",
    "resume-award-2-name": "北京大学三好学生",
    "resume-award-2-detail": "2024–2025 学年",
    "resume-award-3-name": "CMC 初赛（数学A类）三等奖",
    "resume-award-3-detail": "2025年",
    "resume-standardized-h2": "标准化成绩",
    "resume-standardized-1-name": "TOEFL iBT",
    "resume-standardized-1-detail": "110 · CEFR C1 · 2025.12",
    "resume-standardized-2-name": "GRE",
    "resume-standardized-2-detail": "327/4.0 · 2026.01",
    "resume-standardized-3-name": "大学英语六级",
    "resume-standardized-3-detail": "641 · 口试良好 · 2025.06",
    "resume-standardized-4-name": "普通话水平测试",
    "resume-standardized-4-detail": "93.4 · 一级乙等 · 2025年",
    "resume-skills-h2": "技能摘要",
    "resume-skill-1": "Python / 数据处理 / 数值计算 / 数据可视化",
    "resume-skill-2": "数学建模 / 微分方程 / 机理—数据融合",
    "resume-skill-3": "回归分析 / 特征消融 / 敏感性分析",
    "resume-skill-4": "Java / AST 处理 / DSL 转换",
    "resume-skill-5": "Z3 / SMT / 时序性质 / 有界模型检查",
    "resume-skill-6": "中英文技术写作 / 学术表达 / 团队协作",
    "resume-interests-h2": "兴趣与长期实践",
    "resume-interest-1-label": "跑步：",
    "resume-interest-1": "截至当前记录已完赛 7 场，累计 128.29 km；半程马拉松 PB 1:50:47，10 公里 PB 55:07，另有 20.8 km 越野完赛。",
    "resume-interest-running-link": "查看跑步记录",
    "prj-h2": "全部项目",
    "prj-back": "返回首页",
    "art-h2": "阅读与创作",
    "art-back": "返回首页",
    ...
    "skl-eyebrow": "技能",
    "skl-h2": "技能",
    "skl-copy": "以数学建模、定量分析、形式化验证与技术写作为主，相关实现和方法见项目案例与论文。",
    "skl-modeling-h2": "数学建模与定量分析",
    "skl-modeling-copy": "将统计学习、微分方程与领域知识结合，用于解释和预测真实系统。",
    "skl-modeling-1": "Python",
    "skl-modeling-2": "数据处理",
    "skl-modeling-3": "数值计算",
    "skl-modeling-4": "数学建模",
    "skl-modeling-5": "微分方程",
    "skl-modeling-6": "Ridge Regression",
    "skl-modeling-7": "敏感性分析",
    "skl-modeling-8": "不确定性量化",
    "skl-verification-h2": "形式化验证与程序分析",
    "skl-verification-copy": "从 AST 和 DSL 出发，将系统模型与时序性质转换为可检查的约束。",
    "skl-verification-1": "Java",
    "skl-verification-2": "AST 处理",
    "skl-verification-3": "DSL 转换",
    "skl-verification-4": "Z3",
    "skl-verification-5": "SMT",
    "skl-verification-6": "时序性质",
    "skl-verification-7": "有界模型检查",
    "skl-writing-h2": "技术写作与学术协作",
    "skl-writing-copy": "将建模假设、实现方法与实验结果整理为结构清晰的中英文技术文档，并在团队项目中承担论文写作和结果表达。",
    "skl-writing-1": "中英文技术写作",
    "skl-writing-2": "学术表达",
    "skl-writing-3": "数据可视化",
    "skl-writing-4": "论文整理",
    "skl-writing-5": "团队协作",
    "skl-cta-primary": "查看项目案例",
    "skl-cta-ghost": "联系我",
    "cnt-h2": "联系我",
  ...
  en: {
    ...
    "resume-education-coursework-link": "View Coursework Archive",
    ...
    "resume-project-repo-link": "View collaborative GitHub repository",
    "resume-view-projects": "View Projects",
    "resume-view-articles": "View Articles",
    "resume-awards-h2": "Honors & Awards",
    "resume-award-1-name": "Peking University Li Huirong Scholarship",
    "resume-award-1-detail": "2024–2025 academic year",
    "resume-award-2-name": "Peking University Merit Student",
    "resume-award-2-detail": "2024–2025 academic year",
    "resume-award-3-name": "CMC Preliminary Round (Mathematics Category A), Third Prize",
    "resume-award-3-detail": "2025",
    "resume-standardized-h2": "Standardized Test Scores",
    "resume-standardized-1-name": "TOEFL iBT",
    "resume-standardized-1-detail": "110 · CEFR C1 · Dec 2025",
    "resume-standardized-2-name": "GRE",
    "resume-standardized-2-detail": "327/4.0 · Jan 2026",
    "resume-standardized-3-name": "CET-6",
    "resume-standardized-3-detail": "641 · Oral test: Good · Jun 2025",
    "resume-standardized-4-name": "Putonghua Proficiency Test",
    "resume-standardized-4-detail": "93.4 · Level 1-B · 2025",
    "resume-skills-h2": "Skills Summary",
    "resume-skill-1": "Python / data processing / numerical computing / visualization",
    "resume-skill-2": "Mathematical modeling / differential equations / mechanistic-data integration",
    "resume-skill-3": "Regression / feature ablation / sensitivity analysis",
    "resume-skill-4": "Java / AST processing / DSL translation",
    "resume-skill-5": "Z3 / SMT / temporal properties / bounded model checking",
    "resume-skill-6": "Chinese-English technical writing / academic communication / teamwork",
    "resume-interests-h2": "Interests & Sustained Practice",
    "resume-interest-1-label": "Running: ",
    "resume-interest-1": "As of the current record, I have completed 7 races totaling 128.29 km, with a half-marathon PB of 1:50:47, a 10 km PB of 55:07, and a 20.8 km trail-race finish.",
    "resume-interest-running-link": "View Running Records",
    "prj-h2": "All Projects",
    ...
    "skl-eyebrow": "SKILLS",
    "skl-h2": "Skills",
    "skl-copy": "My work centers on mathematical modeling, quantitative analysis, formal verification, and technical writing, with implementation details documented in project case studies and papers.",
    "skl-modeling-h2": "Mathematical Modeling & Quantitative Analysis",
    "skl-modeling-copy": "Combining statistical learning, differential equations, and domain knowledge to explain and predict real systems.",
    "skl-modeling-1": "Python",
    "skl-modeling-2": "Data processing",
    "skl-modeling-3": "Numerical computing",
    "skl-modeling-4": "Mathematical modeling",
    "skl-modeling-5": "Differential equations",
    "skl-modeling-6": "Ridge Regression",
    "skl-modeling-7": "Sensitivity analysis",
    "skl-modeling-8": "Uncertainty quantification",
    "skl-verification-h2": "Formal Verification & Program Analysis",
    "skl-verification-copy": "Starting from ASTs and DSLs, translating system models and temporal properties into checkable constraints.",
    "skl-verification-1": "Java",
    "skl-verification-2": "AST processing",
    "skl-verification-3": "DSL translation",
    "skl-verification-4": "Z3",
    "skl-verification-5": "SMT",
    "skl-verification-6": "Temporal properties",
    "skl-verification-7": "Bounded model checking",
    "skl-writing-h2": "Technical Writing & Academic Collaboration",
    "skl-writing-copy": "Turning modeling assumptions, implementation methods, and experimental results into clear Chinese-English technical documents, while contributing to paper writing and result communication in team projects.",
    "skl-writing-1": "Chinese-English technical writing",
    "skl-writing-2": "Academic communication",
    "skl-writing-3": "Data visualization",
    "skl-writing-4": "Paper organization",
    "skl-writing-5": "Teamwork",
    "skl-cta-primary": "View Project Cases",
    "skl-cta-ghost": "Contact Me",
    "cnt-h2": "Contact",
...
function renderRunningStats() {
  ...
  const totalDistance = finished.reduce((sum, item) => sum + (Number(item.distanceKm) || 0), 0);
