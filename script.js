...
const translations = {
  zh: {
    ...
    "resume-edu-1-courses": "主修课程：数学分析、线性代数、数据结构、机器学习基础、计算系统生物学、大学语文。",
    "resume-edu-1.5-time": "2024.09 - 至今",
    "resume-edu-1.5-school": "北京大学",
    "resume-edu-1.5-subschool":"社会学系",
    "resume-edu-1.5-major": "社会学（双专业）",
    "resume-edu-1.5-courses": "主修课程：社会学概论、国外社会学学说。",
    "resume-edu-2-time": "2021.09 - 2024.06",
    "resume-edu-2-school": "示例高中（可替换）",
    "resume-edu-2-major": "高中阶段（理科方向）",
    "resume-edu-2-courses": "相关学习：高等数学先修、物理、英语写作与阅读训练。",
  ...
  en: {
    ...
    "resume-edu-1-courses": "Key courses: Mathematical Analysis, Linear Algebra, Data Structures, Foundations of Machine Learning, Computational Systems Biology, College Chinese.",
    "resume-edu-1.5-time": "Sep 2024 - Present",
    ...
    "resume-edu-1.5-courses": "Key courses: Introduction to Sociology, Foreign Sociological Theories.",
    "resume-edu-2-time": "Sep 2021 - Jun 2024",
    "resume-edu-2-school": "Sample High School (replace as needed)",
    "resume-edu-2-major": "High School Track (Science)",
    "resume-edu-2-courses": "Related study: Pre-calculus, Physics, English writing and reading training.",
...
function renderArticleCard(article) {
  ...
  const badge = createEl("span", "meta-badge", t(article.type === "pdf" ? "meta-type-pdf" : "meta-type-html"));
  const desc = createEl("p", "", getLocalizedValue(article.listDescription || article.description));
  const meta = createEl("div", "article-meta");
  const actions = createEl("div", "article-actions");
  const open = createEl("a", "btn btn-primary", t(article.type === "pdf" ? "article-open-pdf" : "article-open-html"));
